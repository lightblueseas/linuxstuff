...
export WORKSPACE_HOME=${WORKSPACES_HOME}/flirteros.de
...
nice -n -5 ${ECLIPSE_EXECUTABLE} /i /max /high --launcher.GTK_version 2 -data ${WORKSPACE_HOME} -showlocation vmargs ${VM_ARGS} -javaagent:${ECLIPSE_HOME}/lombok.jar -Xbootclasspath/a:${ECLIPSE_HOME}/lombok.jar -Djava.library.path=${JAVA_LIBRARY_PATH} 
