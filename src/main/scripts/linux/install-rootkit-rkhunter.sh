...
# Rootkit Hunter Installation Script for Multiple OS
# This script installs Rootkit Hunter (rkhunter) based on the detected OS
...
declare -A descriptions=(
    ["rkhunter"]="Rootkit Hunter - a security monitoring and rootkit detection tool."
)
...
info "Verifying Rootkit Hunter installation..."
for component in "${TO_INSTALL[@]}"; do
...
info "Rootkit Hunter installation completed successfully on $OS."
